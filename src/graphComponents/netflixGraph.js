...
import netflix from '../logos/Company=Netflix.svg'
...
class NetflixGraph extends React.Component{
    render(){
        return(
...
class NetflixGraphData extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/candle?symbol=NFLX&resolution=D&from=1670518800&to=1673188219&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
...
class NetflixProfile extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/profile2?symbol=NFLX&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
...
class NetflixMarket extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/metric?symbol=NFLX&metric=all&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
