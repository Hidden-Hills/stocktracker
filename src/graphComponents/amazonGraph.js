...
class AmazonGraph extends React.Component{
    render(){
        return(
...
class AmazonGraphData extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/candle?symbol=AMZN&resolution=D&from=1670518800&to=1673188219&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
...
class AmazonProfile extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/profile2?symbol=AMZN&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
...
class AmazonMarket extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/metric?symbol=AMZN&metric=all&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
