...
class CoinbaseGraph extends React.Component{
    render(){
        return(
...
class CoinbaseGraphData extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/candle?symbol=COIN&resolution=D&from=1670518800&to=1673188219&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
...
class CoinbaseProfile extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/profile2?symbol=COIN&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
...
class CoinbaseMarket extends React.Component{
  constructor(props){
    super(props)
  ...
  componentDidMount(){
    var options = {
      method: 'GET',
      url: 'https://finnhub.io/api/v1/stock/metric?symbol=COIN&metric=all&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
    };
