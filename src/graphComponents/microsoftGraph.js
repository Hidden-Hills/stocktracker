...
import microsoft from '../logos/Company=Microsoft.svg'
...
const Card = { 
  ...
  class MicrosoftGraph extends React.Component{
      render(){
          return(
  ...
  class MicrosoftGraphData extends React.Component{
    constructor(props){
      super(props)
    ...
    componentDidMount(){
      var options = {
        method: 'GET',
        url: 'https://finnhub.io/api/v1/stock/candle?symbol=MSFT&resolution=D&from=1670518800&to=1673188219&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
      };
  ...
  class MicrosoftProfile extends React.Component{
    constructor(props){
      super(props)
    ...
    componentDidMount(){
      var options = {
        method: 'GET',
        url: 'https://finnhub.io/api/v1/stock/profile2?symbol=MSFT&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
      };
  ...
  class MicrosoftMarket extends React.Component{
    constructor(props){
      super(props)
    ...
    componentDidMount(){
      var options = {
        method: 'GET',
        url: 'https://finnhub.io/api/v1/stock/metric?symbol=MSFT&metric=all&token=ceqck4qad3i9f7a4s08gceqck4qad3i9f7a4s090',
      };
